...
area_of_origin <- sample(c("24 - Cooking Area or Kitchen", 
                           "12 - Hallway, Corridor", 
                           "79 - Other Outside Area"), n, replace=TRUE)

extent_of_fire <- sample(c("1 - Confined to object of origin", 
                           "2 - Confined to part of room/area of origin"), n, replace=TRUE)

ignition_source <- sample(c("41 - Other Heating Equipment", 
                            "11 - Stove, Range-top burner", 
                            "24 - Circuit Wiring - Copper"), n, replace=TRUE)
