...
head(cleaned_data_tfs, 5) |>
  kable(
    col.names = c("Alarm Time", "TFS Arrival Time", "TFS Response Time", "Estimated Loss in Dollar"),
      )
```
